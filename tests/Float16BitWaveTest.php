...
use RemiTheFox\Wave\Float16BitWave;
use RemiTheFox\Wave\Wave;

final class Float16BitWaveTest extends AbstractFloatWaveTest
{
    public function testGetBitsPerSample(): void
    {
        ...
        $this->assertSame(16, $floatWave->getBitsPerSample());
    }
    ...
    protected function makeWaveMock(int $bitrate = 16): Wave|MockObject
    {
    ...
    protected function makeFloatWaveObject(Wave $wave): Float16BitWave
    {
        return new Float16BitWave($wave);
    }
}